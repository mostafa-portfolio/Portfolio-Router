    ...
    return (
        <aside className="side-bar">
            ...
            <div className="side-intro">
                <h2>Mostafa Reda</h2>
                <p className="title">Industrial Engineer | D365 F&O Functional Consultant</p>
            </div>
